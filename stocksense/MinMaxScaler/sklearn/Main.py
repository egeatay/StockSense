...
#_______________________________________Main for running___________________________________________________
...
def main():
    ...
    for stock, size_set, size in zip(stocks, test_set_sizes,sizes):
        ...
        X_train, y_train = Clean.cleaning(data,cd,stockLocation,size_set)

        s.modelTrain(X_train,y_train,stockLocation,cd)
